    ...
    <>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 border border-gray-200 px-2 md:px-3 py-1.5 md:py-2 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    {user.avatar ? (
                      <img
                        src={getAvatarUrl()}
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 animate-fadeIn">
                      ...
                      <div className="py-1">
                        ...
                        {user?.role === 'collector' && (
                          <Link to="/seller/collector-settings" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            Dashboard Pengepul
                ...
                <Link to="/login" className="bg-blue-600 hover:bg-blue-700 text-white px-4 md:px-6 py-2 rounded-full text-sm font-semibold transition-all shadow-sm hover:shadow-md">
                  Masuk
                </Link>
              )}
            </div>
          ...
          {/* Kategori Bar (Desktop Only) */}
          <div className="hidden md:flex items-center justify-between py-4 border-b border-gray-50 mb-8">
