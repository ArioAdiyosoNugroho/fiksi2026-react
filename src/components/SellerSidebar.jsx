...
export default function SellerSidebar({ isOpen, setIsOpen }) {
  ...
  const menuItems = [
    ...
    { path: '/seller/messages', icon: 'fas fa-comments', label: 'Pesan Pembeli' },
    { path: '/profile', icon: 'fas fa-user-circle', label: 'Profil Saya' },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-gray-800">Dashboard Penjual</h2>
